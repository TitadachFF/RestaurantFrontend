    ...
    >
      ...
      <div id="logo" className="flex justify-between items-center mx-auto p-3 ">
        ...
        <div className="flex md:order-2">
          <Link className="nav-link flex text-white bg-pink-300 hover:bg-pink-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" to="Signin"
      ...
      <nav id="nav2" className="md:flex justify-center bg-white text-pink-500">
        <div className="flex ">
          <ul className="flex flex-row space-x-4 md:space-x-6">
            <li className="nav2-item">
              ...
              >
                <img className=" w-[50px] content-center    mx-[20px]  "
                  id="nav2img"
            ...
            <li>
              ...
              >
                <img className=" w-[50px] content-center    mx-[40px]  "
                  id="nav4img"
